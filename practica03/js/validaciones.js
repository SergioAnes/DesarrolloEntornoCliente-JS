...
//Me queda por VALIDAR BIEN EL IBAN (creo que ya está). Y ALGO MÁS, PERO NO RECUERDO BIEN. ¿QUIZÁ EL TEMA DE LOS NÚMEROS NEGATIVOS O LO DEL FAX?
//TAMBIÉN ME QUEDARÍA POR VALIDAR BIEN LA FECHA DE CONSTITUCIÓN DE LA EMPRESA, CONTANDO AÑOS BISIESTOS Y TAL, PORQUE LO QUE TENGO AHORA ES UN POCO CHAPUZA. 

function inicio () {
  document.formulario.validar.onclick = comprobar;
  document.formulario.codigoPostal.onblur=codigoPostal; //Dice Felix que lo hagamos así, es decir, que al quitarle el foco a codigoPostal se rellene la provincia. 
}
...
//parametros generales
  ...
  if (resultanif!="C1" && resultanif!="N1" ) { //Todo lo que sea que la función NIFCIF devuelva algo diferente a C1 o a N1 significa que algo falla, así que el NIF O CIF sería incorrecto.
