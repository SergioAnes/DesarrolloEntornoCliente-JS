...
//Me queda por VALIDAR BIEN EL IBAN. Y ALGO MÁS, PERO NO RECUERDO BIEN. ¿QUIZÁ EL TEMA DE LOS NÚMEROS NEGATIVOS O LO DEL FAX?
//TAMBIÉN ME QUEDARÍA POR VALIDAR BIEN LA FECHA DE CONSTITUCIÓN DE LA EMPRESA, CONTANDO AÑOS BISIESOTS Y TAL, PORQUE LO QUE TENGO AHORA ES UN POCO CHAPUZA. 
...
//El codigo IBAN tiene que tener: 2 letras, dos digitos control y el codigo de la cuenta. Dependerá del país. El número máximo de caracteres, eso sí, será de 34.
  var cuatroPrimeros = codigoIBAN.slice(0,4); //Los cuatro primeros caracteres del IBAN. El 5 no lo tiene en cuenta. 
...
//hay que colocar los cuatro primeros caracteres del IBAN al final. 
    var IBANcolocado= codigoIBAN.slice(4)+letra1Numero1+letra2Numero2+cuatroPrimeros.slice(2,4); 
...
while (IBANPartes.length>=10){//es decir, si el número es muy grande. Y lo va a ser siempre porque solo hay un IBAN de 16 digitos, haz lo siguiente:
